package testscripts.SF.AdminRelease49TestScripts;
  ...
  public class TC_SF_CMEMEAManagerAdminOppAssignmentTypeFields  extends CRAFTTestCase
  	{
		@Test(groups= {"REGRESSION","API","Manager","Opportunity","Fields"},dataProvider = "RegressionTestScripts")
  		public void runTC_SF_CMEMEAManagerAdminOppAssignmentTypeFields(String testInstance, ExecutionMode executionMode, Platform platform
