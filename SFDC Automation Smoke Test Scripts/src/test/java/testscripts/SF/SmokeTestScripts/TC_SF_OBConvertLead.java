...
public class TC_SF_OBConvertLead extends CRAFTTestCase
{
	@Test(dataProvider = "SmokeTestScripts")
	public void runTC_SF_OBConvertLead(String testInstance, ExecutionMode executionMode, Platform platform
