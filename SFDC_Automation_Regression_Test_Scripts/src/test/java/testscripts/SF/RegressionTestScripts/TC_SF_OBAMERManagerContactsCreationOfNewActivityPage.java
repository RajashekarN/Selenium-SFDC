...
/**
 * Test Script for for validating the new activity creation on the Contact Page from the manager profile for the Occupancy Broker
 * 
 * @author Ramya
 *
 */

public class TC_SF_OBAMERManagerContactsCreationOfNewActivityPage extends CRAFTTestCase
{
	@Test(groups= {"REGRESSION","UI","Manager","Contact","Activity"},dataProvider = "RegressionTestScripts")
	public void runTC_SF_OBEMEAManagerContactsCreationOfNewActivityPage(String testInstance, ExecutionMode executionMode, Platform platform
