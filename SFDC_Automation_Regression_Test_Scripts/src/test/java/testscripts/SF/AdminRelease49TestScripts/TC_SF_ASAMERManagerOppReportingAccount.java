...
/**
 * Test Script for validating the CBRE 360 office field  on Opp page
 * 
 * @author Haritha
 *
 */

public class TC_SF_ASAMERManagerOppReportingAccount extends CRAFTTestCase
{
	@Test(groups= {"REGRESSION","API","Manager","Opportunity","Layout"},dataProvider = "RegressionTestScripts")
	public void runTC_SF_ASAMERManagerOppReportingAccount(String testInstance, ExecutionMode executionMode, Platform platform
			/*MobileToolName mobileToolName,
					MobileExecutionPlatform executionPlatform, String deviceName*/)
	{
		SeleniumTestParameters testParameters = new SeleniumTestParameters(currentScenario, currentTestcase);
		testParameters.setCurrentTestDescription("Test for validating the CBRE 360 office field  on Opp page");
