...
/**
 * Test Script for for validating the creation of Activity from Properties with a broker profile from Agency Brokerage
 * 
 * @author Ramya
 *
 */

public class TC_SF_ABAMERBrokerPropertiesCreationOfNewActivityPage extends CRAFTTestCase
{
	@Test(groups= {"REGRESSION","UI","Broker","Property","Activity"},dataProvider = "RegressionTestScripts")
	public void runTC_SF_ABEMEABrokerPropertiesCreationOfNewActivityPage(String testInstance, ExecutionMode executionMode, Platform platform
