...
public class TC_SF_OBAMERCSSContactsPopulatingAllFields extends CRAFTTestCase
{
	@Test(groups= {"REGRESSION","API","CSS","Conatct","Field"},dataProvider = "RegressionTestScripts")
	public void runTC_SF_OBAMERCSSContactsPopulatingAllFields(String testInstance, ExecutionMode executionMode, Platform platform
