...
public class TC_SF_OBAMERManagerContactsPopulatingAllFields extends CRAFTTestCase
{
	@Test(groups= {"REGRESSION","API","Manager","Contact","Field"},dataProvider = "RegressionTestScripts")
	public void runTC_SF_OBAMERManagerContactsPopulatingAllFields(String testInstance, ExecutionMode executionMode, Platform platform
