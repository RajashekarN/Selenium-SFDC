...
public class TC_SF_OBAMERManagerLeadsConvertPage extends CRAFTTestCase
{
	@Test(groups= {"REGRESSION","API","Manager","Lead","Convert"},dataProvider = "RegressionTestScripts")
	public void runTC_SF_OBAMERManagerLeadsConvertPage(String testInstance, ExecutionMode executionMode, Platform platform
			/*MobileToolName mobileToolName,
			MobileExecutionPlatform executionPlatform, String deviceName*/)
	{
		SeleniumTestParameters testParameters = new SeleniumTestParameters(currentScenario, currentTestcase);
		testParameters.setCurrentTestDescription("Test Script for validating the Lead convert with the Direct Line and Private Notes for the Occupancy Broker");
