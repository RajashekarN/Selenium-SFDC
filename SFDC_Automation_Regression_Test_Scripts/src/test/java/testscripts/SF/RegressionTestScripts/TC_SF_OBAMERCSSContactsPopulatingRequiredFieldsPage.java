...
public class TC_SF_OBAMERCSSContactsPopulatingRequiredFieldsPage extends CRAFTTestCase
{
	@Test(groups= {"REGRESSION","API","CSS","Conatct","Field"},dataProvider = "RegressionTestScripts")
	public void runTC_SF_OBAMERCSSContactsPopulatingRequiredFieldsPage(String testInstance, ExecutionMode executionMode, Platform platform
