...
/**
 * Test Script for validating the multiple installment uneven percentage
 * 
 * @author Vishnuvardhan
 *
 */
public class TC_SF_ABAMERBrokerMultipleInstallmentsUnEvenPercent extends CRAFTTestCase
{
	@Test(groups= {"Regression","UI","Broker","Opportunity","Installment"},dataProvider = "RegressionTestScripts")
	public void runTC_SF_ABAMERBrokerMultipleInstallmentsUnEvenPercent(String testInstance, ExecutionMode executionMode, Platform platform
			/*MobileToolName mobileToolName,
			MobileExecutionPlatform executionPlatform, String deviceName*/)
	{
		SeleniumTestParameters testParameters = new SeleniumTestParameters(currentScenario, currentTestcase);
		testParameters.setCurrentTestDescription("Test validating the multiple installment even percentage");
