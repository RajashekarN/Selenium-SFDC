 ...
 *
 */
public class TC_SF_ABEMEAManagerPropertySalesSellSideOpptCreation extends CRAFTTestCase {
	@Test(groups= {"Regression","UI","Broker","Project Enquiries","Generate"},dataProvider = "RegressionTestScripts")
	public void runTC_SF_ABEMEAManagerPropertySalesSellSidePagelayOut(String testInstance, ExecutionMode executionMode, Platform platform
			/*MobileToolName mobileToolName,
			MobileExecutionPlatform executionPlatform, String deviceName*/)
	{
		SeleniumTestParameters testParameters = new SeleniumTestParameters(currentScenario, currentTestcase);
		testParameters.setCurrentTestDescription("Oppt Creation - EMEA Property sales - Sell Side");
