...
/**
 * Test Script for validating the Opportunity delete installment
 * 
 * @author Vishnuvardhan
 *
 */
public class TC_SF_OBAMERBrokerDeleteInstallmentOpportunity extends CRAFTTestCase
{
	@Test(groups= {"Regression","UI","Broker","Opportunity","Installment"},dataProvider = "RegressionTestScripts")
	public void runTC_SF_OBAMERBrokerDeleteInstallmentOpportunity(String testInstance, ExecutionMode executionMode, Platform platform
			/*MobileToolName mobileToolName,
			MobileExecutionPlatform executionPlatform, String deviceName*/)
	{
		SeleniumTestParameters testParameters = new SeleniumTestParameters(currentScenario, currentTestcase);
		testParameters.setCurrentTestDescription("Test validating the Opportunity delete installment");
