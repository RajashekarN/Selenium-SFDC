 ...
 *
 */
public class TC_SF_OBAMERCSSAutoGeneratedOpportunity extends CRAFTTestCase
{
	@Test(dataProvider = "Regression")
	public void runTC_SF_OBAMERCSSAutoGeneratedOpportunity(String testInstance, ExecutionMode executionMode, Platform platform
