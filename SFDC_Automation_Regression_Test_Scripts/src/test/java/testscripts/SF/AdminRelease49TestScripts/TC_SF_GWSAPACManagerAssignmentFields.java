...
public class TC_SF_GWSAPACManagerAssignmentFields extends CRAFTTestCase {
	
		@Test(groups= {"REGRESSION","API","Data Admin","Opportunity","Fields"},dataProvider = "RegressionTestScripts")
		public void runTC_SF_GWSAPACManagerAssignmentFields (String testInstance, ExecutionMode executionMode, Platform platform
				/*MobileToolName mobileToolName,
				MobileExecutionPlatform executionPlatform, String deviceName*/)
		{
			SeleniumTestParameters testParameters = new SeleniumTestParameters(currentScenario, currentTestcase);
			testParameters.setCurrentTestDescription("Validating the Assignment Start date and End Date fields on Opportunity object");
