...
/**
 * Test Script for validating the links present in Home Page by logging as Admin
 * 
 * @author Vishnuvardhan
 *
 */
public class TC_SF_AdminHomePageLinks extends CRAFTTestCase
{
	@Test(dataProvider = "SmokeTestScripts")
	public void runTC_SF_AdminHomePageLinks(String testInstance, ExecutionMode executionMode, Platform platform
