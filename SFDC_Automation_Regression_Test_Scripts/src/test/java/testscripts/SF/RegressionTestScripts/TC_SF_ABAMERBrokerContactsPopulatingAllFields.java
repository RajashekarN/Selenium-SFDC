...
public class TC_SF_ABAMERBrokerContactsPopulatingAllFields extends CRAFTTestCase
{
	@Test(groups= {"REGRESSION","API","Broker","Contact","Fields"},dataProvider = "RegressionTestScripts")
	public void runTC_SF_ABAMERBrokerContactsPopulatingAllFields(String testInstance, ExecutionMode executionMode, Platform platform
			/*MobileToolName mobileToolName,
			MobileExecutionPlatform executionPlatform, String deviceName*/)
	{
		SeleniumTestParameters testParameters = new SeleniumTestParameters(currentScenario, currentTestcase);
		testParameters.setCurrentTestDescription("Test for validating the contacts populating the All fields");
