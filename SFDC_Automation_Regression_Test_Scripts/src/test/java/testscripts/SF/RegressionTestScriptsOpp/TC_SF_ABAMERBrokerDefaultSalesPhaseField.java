 ...
 *
 */
public class TC_SF_ABAMERBrokerDefaultSalesPhaseField extends CRAFTTestCase
{
	@Test(groups= {"Regression","UI","Broker","Opportunity","Sales"},dataProvider = "RegressionTestScripts")
	public void runTC_SF_ABAMERBrokerDefaultSalesPhaseField(String testInstance, ExecutionMode executionMode, Platform platform
