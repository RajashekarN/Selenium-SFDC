 ...
 *
 */
public class TC_SF_ABAMERBrokerAssociateProperty extends CRAFTTestCase
{
	@Test(groups= {"REGRESSION","UI","Broker","Opportunity","Property"},dataProvider = "RegressionTestScripts")
	public void runTC_SF_ABAMERBrokerAssociateProperty(String testInstance, ExecutionMode executionMode, Platform platform
