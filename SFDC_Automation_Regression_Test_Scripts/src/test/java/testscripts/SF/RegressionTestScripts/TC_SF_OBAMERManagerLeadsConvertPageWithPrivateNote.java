...
public class TC_SF_OBAMERManagerLeadsConvertPageWithPrivateNote extends CRAFTTestCase
{
	@Test(groups= {"REGRESSION","API","Manager","Lead","Convert"},dataProvider = "RegressionTestScripts")
	public void runTC_SF_OBAMERManagerLeadsConvertPageWithPrivateNote(String testInstance, ExecutionMode executionMode, Platform platform
