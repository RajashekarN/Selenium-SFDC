 ...
 *
 */
public class TC_SF_OBAPACBrokerAccountRecordType extends CRAFTTestCase
{
	@Test(dataProvider = "RegressionTestScripts")
	public void runTC_SF_OBAPACBrokerAccountRecordType(String testInstance, ExecutionMode executionMode, Platform platform
