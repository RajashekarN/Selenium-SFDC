 ...
 *
 */
public class TC_SF_CMAMERBrokerDSFAutoGeneratedOpportunity extends CRAFTTestCase
{
	@Test(groups= {"Regression","API","Broker","Opportunity","Generate"},dataProvider = "RegressionTestScripts")
	public void runTC_SF_CMAMERBrokerDSFAutoGeneratedOpportunity(String testInstance, ExecutionMode executionMode, Platform platform
