 ...
 *
 */
public class TC_SF_OBAMERCSSDefaultSalesPhaseField extends CRAFTTestCase
{
	@Test(groups= {"Regression","UI","CSS","Opportunity","Sales"},dataProvider = "RegressionTestScripts")
	public void runTC_SF_OBAMERCSSDefaultSalesPhaseField(String testInstance, ExecutionMode executionMode, Platform platform
