...
/**
 * Validating the creation of Event on Account
 * 
 * @author Vishnu
 *
 */

public class TC_SF_FDIREMEAManagerEventonAccount extends CRAFTTestCase {
	@Test(groups= {"UAT","API","France","Manager","Account","Event"},dataProvider = "UATTestScripts")
	public void runTC_SF_FDIREMEAManagerEventonAccount(String testInstance, ExecutionMode executionMode, Platform platform
			/*MobileToolName mobileToolName,
			MobileExecutionPlatform executionPlatform, String deviceName*/)
	{
		SeleniumTestParameters testParameters = new SeleniumTestParameters(currentScenario, currentTestcase);
		testParameters.setCurrentTestDescription("Test for creation of Event on Account for FDIREMEA");
