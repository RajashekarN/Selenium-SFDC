...
/**
 * Test Script for validating the contacts populating the required fields
 * 
 * @author Ramya
 *
 */

public class TC_SF_ABAMERManagerContactsPopulatingRequiredFieldsPage extends CRAFTTestCase
{
	@Test(groups= {"REGRESSION","API","Manager","Contact","Fields"},dataProvider = "RegressionTestScripts")
	public void runTC_SF_ABAMERManagerContactsPopulatingRequiredFieldsPage(String testInstance, ExecutionMode executionMode, Platform platform
