 ...
 *
 */
public class TC_SF_ABEMEABrokerDefaultSalesPhaseField extends CRAFTTestCase
{
	@Test(groups= {"Regression","UI","Broker","Opportunity","Sales"},dataProvider = "RegressionTestScripts")
	public void runTC_SF_ABEMEABrokerDefaultSalesPhaseField(String testInstance, ExecutionMode executionMode, Platform platform
