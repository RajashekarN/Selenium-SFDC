...
public class TC_SF_OBAMERBrokerContactsPopulatingAllFields extends CRAFTTestCase
{
	@Test(groups= {"REGRESSION","API","Broker","Contact","Field"},dataProvider = "RegressionTestScripts")
	public void runTC_SF_OBAMERBrokerContactsPopulatingAllFields(String testInstance, ExecutionMode executionMode, Platform platform
