...
/**
 * Validating the creation of Campaign via Lead 
 * 
 * @author Vishnu
 *
 */

public class TC_SF_CMAPACManagerLeadAddCampaign extends CRAFTTestCase {
	@Test(groups= {"UAT","API","Manager","Lead","Campaign"},dataProvider = "UATTestScripts")
	public void runTC_SF_CMAPACManagerLeadAddCampaign(String testInstance, ExecutionMode executionMode, Platform platform
			/*MobileToolName mobileToolName,
			MobileExecutionPlatform executionPlatform, String deviceName*/)
	{
		SeleniumTestParameters testParameters = new SeleniumTestParameters(currentScenario, currentTestcase);
		testParameters.setCurrentTestDescription("Test for validating the creation of Campaign via Lead for CMAPAC");
