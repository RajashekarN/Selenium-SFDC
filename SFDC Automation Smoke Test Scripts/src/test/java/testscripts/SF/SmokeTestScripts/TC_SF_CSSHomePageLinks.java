 ...
 *
 */
public class TC_SF_CSSHomePageLinks extends CRAFTTestCase
{
	@Test(dataProvider = "SmokeTestScripts")
	public void runTC_SF_CSSHomePageLinks(String testInstance, ExecutionMode executionMode, Platform platform
