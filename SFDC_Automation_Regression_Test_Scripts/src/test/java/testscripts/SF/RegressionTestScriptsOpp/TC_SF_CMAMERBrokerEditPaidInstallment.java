 ...
 *
 */
public class TC_SF_CMAMERBrokerEditPaidInstallment extends CRAFTTestCase
{
	@Test(groups= {"Regression","UI","Broker","Opportunity","Installment"},dataProvider = "RegressionTestScripts")
	public void runTC_SF_CMAMERBrokerEditPaidInstallment(String testInstance, ExecutionMode executionMode, Platform platform
