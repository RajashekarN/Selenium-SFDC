 ...
 *
 */
public class TC_SF_OBAMERBrokerDefaultSalesPhaseField extends CRAFTTestCase
{
	@Test(groups= {"Regression","UI","Broker","Opportunity","Sales"},dataProvider = "RegressionTestScripts")
	public void runTC_SF_OBAMERBrokerDefaultSalesPhaseField(String testInstance, ExecutionMode executionMode, Platform platform
