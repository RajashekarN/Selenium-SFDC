 ...
 *
 */
public class TC_SF_CMAMERCSSPSDefaultSalesPhaseField extends CRAFTTestCase
{
	@Test(groups= {"Regression","UI","CSS","Opportunity","Sales"},dataProvider = "RegressionTestScripts")
	public void runTC_SF_CMAMERCSSPSDefaultSalesPhaseField(String testInstance, ExecutionMode executionMode, Platform platform
