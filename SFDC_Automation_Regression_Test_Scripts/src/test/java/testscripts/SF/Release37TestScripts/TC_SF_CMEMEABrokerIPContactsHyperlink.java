...
public class TC_SF_CMEMEABrokerIPContactsHyperlink extends CRAFTTestCase {
	@Test(dataProvider = "RegressionTestScripts")
	public void runTC_SF_CMEMEABrokerIPContactsHyperlink(String testInstance, ExecutionMode executionMode, Platform platform
