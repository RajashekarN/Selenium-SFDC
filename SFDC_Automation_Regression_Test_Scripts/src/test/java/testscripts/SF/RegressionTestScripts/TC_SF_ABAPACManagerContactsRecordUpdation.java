...
public class TC_SF_ABAPACManagerContactsRecordUpdation extends CRAFTTestCase
{
	@Test(groups= {"REGRESSION","UI","Manager","Contact","Record"},dataProvider = "RegressionTestScripts")
	public void runTC_SF_ABAPACManagerContactsRecordUpdation(String testInstance, ExecutionMode executionMode, Platform platform
