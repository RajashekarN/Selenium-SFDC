 ...
 *
 */
public class TC_SF_CMAMERManagerPSOpportunityNameAutoGenerate extends CRAFTTestCase
{
	@Test(groups= {"Regression","API","Manager","Opportunity","Generate"},dataProvider = "RegressionTestScripts")
	public void runTC_SF_CMAMERManagerPSOpportunityNameAutoGenerate(String testInstance, ExecutionMode executionMode, Platform platform
