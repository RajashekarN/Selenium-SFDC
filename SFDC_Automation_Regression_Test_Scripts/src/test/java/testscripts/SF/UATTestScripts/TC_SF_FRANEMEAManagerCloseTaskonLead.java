...
/**
 * Validating the closure of Task on Lead
 * 
 * @author Vishnu
 *
 */

public class TC_SF_FRANEMEAManagerCloseTaskonLead extends CRAFTTestCase {
	@Test(groups= {"UAT","API","France","Manager","Lead","Task"},dataProvider = "UATTestScripts")
	public void runTC_SF_FRANEMEAManagerCloseTaskonLead(String testInstance, ExecutionMode executionMode, Platform platform
			/*MobileToolName mobileToolName,
			MobileExecutionPlatform executionPlatform, String deviceName*/)
	{
		SeleniumTestParameters testParameters = new SeleniumTestParameters(currentScenario, currentTestcase);
		testParameters.setCurrentTestDescription("Test for validating the closure of Task on Lead");
