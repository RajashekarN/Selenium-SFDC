...
/**
 * Test Script for logging in SFDC using Occupier Brokerage login
 * 
 * @author Vishnuvardhan
 *
 */
public class TC_SF_OBLogin extends CRAFTTestCase
{
	@Test(dataProvider = "SmokeTestScripts")
	public void runTC_SF_OBLogin(String testInstance, ExecutionMode executionMode, Platform platform
			/*MobileToolName mobileToolName,
			MobileExecutionPlatform executionPlatform, String deviceName*/)
	{
		SeleniumTestParameters testParameters = new SeleniumTestParameters(currentScenario, currentTestcase);
		testParameters.setCurrentTestDescription("Test for logging in SFDC using Occupier Brokerage login");
