...
/**
 * Test Script for for validating the creation of New Activity from a Manager Profile for Occupancy Broker
 * 
 * @author Ramya
 *
 */

public class TC_SF_OBAMERManagerPropertiesCreationOfNewActivityPage extends CRAFTTestCase
{
	@Test(groups= {"REGRESSION","UI","Manager","Property","Activity"},dataProvider = "RegressionTestScripts")
	public void runTC_SF_OBEMEAManagerPropertiesCreationOfNewActivityPage(String testInstance, ExecutionMode executionMode, Platform platform
