 ...
 *
 */
public class TC_SF_OBEMEABrokerOccupierRecordType extends CRAFTTestCase
{
	@Test(dataProvider = "RegressionTestScripts")
	public void runTC_SF_OBEMEABrokerOccupierRecordType(String testInstance, ExecutionMode executionMode, Platform platform
