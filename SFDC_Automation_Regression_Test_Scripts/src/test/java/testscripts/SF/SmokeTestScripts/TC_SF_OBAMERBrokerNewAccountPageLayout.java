...
/**
 * Test Script for validating the Account page layout
 * 
 * @author Vishnuvardhan
 *
 */

public class TC_SF_OBAMERBrokerNewAccountPageLayout extends CRAFTTestCase
{
	@Test(groups= {"SMOKE","API","Broker","Account","Layout"},dataProvider = "SmokeTestScripts")
	public void runTC_SF_OBAMERBrokerNewAccountPageLayout(String testInstance, ExecutionMode executionMode, Platform platform
			/*MobileToolName mobileToolName,
			MobileExecutionPlatform executionPlatform, String deviceName*/)
	{
		SeleniumTestParameters testParameters = new SeleniumTestParameters(currentScenario, currentTestcase);
		testParameters.setCurrentTestDescription("Test for validating the Account page layout");
