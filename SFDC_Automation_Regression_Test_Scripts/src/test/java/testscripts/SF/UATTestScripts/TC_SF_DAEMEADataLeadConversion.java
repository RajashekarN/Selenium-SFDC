...
public class TC_SF_DAEMEADataLeadConversion extends CRAFTTestCase {
	@Test(groups= {"UAT","API","DataAdmin","Lead"},dataProvider = "UATTestScripts")
	public void runTC_SF_DAEMEADataLeadConversion(String testInstance, ExecutionMode executionMode, Platform platform
