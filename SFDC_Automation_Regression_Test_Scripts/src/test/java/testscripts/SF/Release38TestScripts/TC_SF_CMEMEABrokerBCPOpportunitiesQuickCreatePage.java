...
public class TC_SF_CMEMEABrokerBCPOpportunitiesQuickCreatePage extends CRAFTTestCase {
	@Test(dataProvider = "RegressionTestScripts")
	public void runTC_SF_CMEMEABrokerBCPOpportunitiesQuickCreatePage(String testInstance, ExecutionMode executionMode, Platform platform
