...
/**
 * Test Script for validating the Opportunity Name Auto generate modify
 * 
 * @author Vishnuvardhan
 *
 */
public class TC_SF_CMAMERBrokerPSModifyAutoGeneratedOpportunityName extends CRAFTTestCase
{
	@Test(groups= {"Regression","API","Broker","Opportunity","Generate"},dataProvider = "RegressionTestScripts")
	public void runTC_SF_CMAMERBrokerPSModifyAutoGeneratedOpportunityName(String testInstance, ExecutionMode executionMode, Platform platform
