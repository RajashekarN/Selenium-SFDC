 ...
 *
 */
public class TC_SF_OBAMERBrokerModifyAutoGeneratedOpportunityName extends CRAFTTestCase
{
	@Test(groups= {"Regression","API","Broker","Opportunity","Generate"},dataProvider = "RegressionTestScripts")
	public void runTC_SF_OBAMERBrokerModifyAutoGeneratedOpportunityName(String testInstance, ExecutionMode executionMode, Platform platform
