 ...
 *
 */
public class TC_SF_ABAMERCSSDefaultSalesPhaseField extends CRAFTTestCase
{
	@Test(groups= {"Regression","UI","CSS","Opportunity","Sales"},dataProvider = "RegressionTestScripts")
	public void runTC_SF_ABAMERCSSDefaultSalesPhaseField(String testInstance, ExecutionMode executionMode, Platform platform
