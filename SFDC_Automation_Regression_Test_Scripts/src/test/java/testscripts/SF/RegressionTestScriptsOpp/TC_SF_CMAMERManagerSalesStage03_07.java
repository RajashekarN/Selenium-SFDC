 ...
 *
 */
public class TC_SF_CMAMERManagerSalesStage03_07 extends CRAFTTestCase
{
	@Test(groups= {"Regression","API","Manager","Opportunity","Sales"},dataProvider = "RegressionTestScripts")
	public void runTC_SF_CMAMERManagerSalesStage03_07(String testInstance, ExecutionMode executionMode, Platform platform
