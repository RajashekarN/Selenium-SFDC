...
/**
 * Validating the closure of Task on Account
 * 
 * @author Vishnu
 *
 */

public class TC_SF_FDIGEMEADataCloseTaskonAccount extends CRAFTTestCase {
	@Test(groups= {"UAT","API","France","Acccount","Task"},dataProvider = "UATTestScripts")
	public void runTC_SF_FDIGEMEADataCloseTaskonAccount(String testInstance, ExecutionMode executionMode, Platform platform
			/*MobileToolName mobileToolName,
			MobileExecutionPlatform executionPlatform, String deviceName*/)
	{
		SeleniumTestParameters testParameters = new SeleniumTestParameters(currentScenario, currentTestcase);
		testParameters.setCurrentTestDescription("Test for validating the closure of Task on Account for FDIGEMEA");
