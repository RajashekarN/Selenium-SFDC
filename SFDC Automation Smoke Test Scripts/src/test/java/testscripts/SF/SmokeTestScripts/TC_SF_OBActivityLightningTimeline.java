...
/**
 * Test Script for validating the Activity Lightning Timeline contacts page
 * 
 * @author Vishnuvardhan
 *
 */

public class TC_SF_OBActivityLightningTimeline extends CRAFTTestCase
{
	@Test(dataProvider = "SmokeTestScripts")
	public void runTC_SF_OBActivityLightningTimeline(String testInstance, ExecutionMode executionMode, Platform platform
