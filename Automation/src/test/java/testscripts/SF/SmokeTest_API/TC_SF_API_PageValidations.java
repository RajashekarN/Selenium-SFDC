...
public class TC_SF_API_PageValidations  extends TestCase  {

	@Test(groups = { "SF API_Test", "Salesforce Portal API Test Scripts" })
	@Parameters("environment")
	public void un_TC_SF_API_PageValidations(@Optional("Sandbox") String environment) {
		driverScript = new DriverScript(testParameters);
		String purpose = "Test API page related validations for Salesforce Portal";
