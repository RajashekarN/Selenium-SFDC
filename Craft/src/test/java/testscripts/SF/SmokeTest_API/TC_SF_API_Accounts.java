 ...
 *
 */
public class TC_SF_API_Accounts extends CRAFTTestCase
{
	@Test(dataProvider = "SmokeTestScripts")
	public void runTC_SF_API_Accounts(String testInstance, ExecutionMode executionMode, Platform platform
