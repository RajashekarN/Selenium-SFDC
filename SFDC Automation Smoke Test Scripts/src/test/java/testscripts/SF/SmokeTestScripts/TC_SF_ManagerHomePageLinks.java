 ...
 *
 */
public class TC_SF_ManagerHomePageLinks extends CRAFTTestCase
{
	@Test(dataProvider = "SmokeTestScripts")
	public void runTC_SF_ManagerHomePageLinks(String testInstance, ExecutionMode executionMode, Platform platform
