...
/**
 * Test Script for for validating the New Activity Layout Page in Accounts from the manager profile for the Occupancy Broker
 * 
 * @author Ramya
 *
 */

public class TC_SF_OBAMERManagerAccountsNewActivityLayoutPage extends CRAFTTestCase
{
	@Test(groups= {"REGRESSION","UI","Manager","Account","Activity"},dataProvider = "RegressionTestScripts")
	public void runTC_SF_OBAMERManagerAccountsNewActivityLayoutPage(String testInstance, ExecutionMode executionMode, Platform platform
