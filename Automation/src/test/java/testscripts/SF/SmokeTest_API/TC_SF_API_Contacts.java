...
public class TC_SF_API_Contacts  extends TestCase  {

	@Test(groups = { "SF API_Test", "Salesforce Portal API Test Scripts" })
	@Parameters("environment")
	public void run_TC_SF_API_Contacts(@Optional("Sandbox") String environment) {
		driverScript = new DriverScript(testParameters);
		String purpose = "Test API Contact related functions for Salesforce Portal";
