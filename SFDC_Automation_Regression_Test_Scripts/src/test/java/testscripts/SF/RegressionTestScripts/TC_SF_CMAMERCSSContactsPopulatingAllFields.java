...
public class TC_SF_CMAMERCSSContactsPopulatingAllFields extends CRAFTTestCase
{
	@Test(groups= {"REGRESSION","API","CSS","Contact","Fields"},dataProvider = "RegressionTestScripts")
	public void runTC_SF_CMAMERCSSContactsPopulatingAllFields(String testInstance, ExecutionMode executionMode, Platform platform
