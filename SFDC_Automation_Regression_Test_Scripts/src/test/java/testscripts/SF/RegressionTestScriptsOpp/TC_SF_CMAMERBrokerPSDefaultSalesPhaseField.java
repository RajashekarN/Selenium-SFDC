 ...
 *
 */
public class TC_SF_CMAMERBrokerPSDefaultSalesPhaseField extends CRAFTTestCase
{
	@Test(groups= {"Regression","UI","Broker","Opportunity","Sales"},dataProvider = "RegressionTestScripts")
	public void runTC_SF_CMAMERBrokerPSDefaultSalesPhaseField(String testInstance, ExecutionMode executionMode, Platform platform
			/*MobileToolName mobileToolName,
			MobileExecutionPlatform executionPlatform, String deviceName*/)
	{
		SeleniumTestParameters testParameters = new SeleniumTestParameters(currentScenario, currentTestcase);
		testParameters.setCurrentTestDescription("Test validating the sales phase field");
