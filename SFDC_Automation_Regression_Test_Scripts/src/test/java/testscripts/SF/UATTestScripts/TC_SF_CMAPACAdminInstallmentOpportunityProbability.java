...
/**
 * Validating the Opportunity Installment probability functionality
 * 
 * @author Vishnu
 *
 */
...
public class TC_SF_CMAPACAdminInstallmentOpportunityProbability extends CRAFTTestCase {
			...
			MobileExecutionPlatform executionPlatform, String deviceName*/)
	{
		...
		testParameters.setCurrentTestDescription("Test for validating the Opportunity Installment probability functionality for CMAPAC");
