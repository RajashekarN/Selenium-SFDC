...
public class TC_SF_CMEMEABrokerIPOpportunitiesQuickCreatePage extends CRAFTTestCase {
	@Test(dataProvider = "RegressionTestScripts")
	public void runTC_SF_CMEMEABrokerIPOpportunitiesQuickCreatePage(String testInstance, ExecutionMode executionMode, Platform platform
