 ...
 *
 */
public class TC_SF_OBAMERBrokerFieldsOnSalesStage16_19 extends CRAFTTestCase
{
	@Test(groups= {"Regression","UI","Broker","Opportunity","Sales"},dataProvider = "RegressionTestScripts")
	public void runTC_SF_OBAMERBrokerFieldsOnSalesStage16_19(String testInstance, ExecutionMode executionMode, Platform platform
