...
/**
 * Test Script for validating the new activity layout page on the Contacts Page from the Manager profile for the Capital Markets
 * 
 * @author Ramya
 *
 */

public class TC_SF_CMAMERManagerContactsNewActivityLayoutPage extends CRAFTTestCase
{
	@Test(dataProvider = "RegressionTestScripts")
	public void runTC_SF_CMAMERManagerContactsNewActivityLayoutPage(String testInstance, ExecutionMode executionMode, Platform platform
