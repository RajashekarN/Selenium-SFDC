 ...
 *
 */
public class TC_SF_CMAMERCSSSalesStage08_09 extends CRAFTTestCase
{
	@Test(groups= {"Regression","UI","CSS","Opportunity","Sales"},dataProvider = "RegressionTestScripts")
	public void runTC_SF_CMAMERCSSSalesStage08_09(String testInstance, ExecutionMode executionMode, Platform platform
