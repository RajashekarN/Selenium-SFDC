 ...
 *
 */
public class TC_SF_ABAMERBrokerOpportunityNameAutoGenerate extends CRAFTTestCase
{
	@Test(dataProvider = "RegressionTestScripts")
	public void runTC_SF_ABAMERBrokerOpportunityNameAutoGenerate(String testInstance, ExecutionMode executionMode, Platform platform
