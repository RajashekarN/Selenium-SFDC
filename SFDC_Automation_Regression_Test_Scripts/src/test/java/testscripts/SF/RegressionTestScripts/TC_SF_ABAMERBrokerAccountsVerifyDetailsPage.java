...
/**
 * Test Script for validating the Accounts details Page
 * 
 * @author Ramya
 *
 */
...
{
	@Test(groups= {"REGRESSION","API","Broker","Account","Details"},dataProvider = "RegressionTestScripts")
			...
			MobileExecutionPlatform executionPlatform, String deviceName*/)
	{
		...
		testParameters.setCurrentTestDescription("Test Script for validating the Accounts details page");
