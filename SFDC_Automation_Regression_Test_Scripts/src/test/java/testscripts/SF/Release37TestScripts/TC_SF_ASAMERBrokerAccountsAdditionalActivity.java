...
/**
 * Validating the Accounts  New Activity Page Activity Type drop down attribute
 * 
 * @author Ramya
 *
 */

public class TC_SF_ASAMERBrokerAccountsAdditionalActivity extends CRAFTTestCase {
	@Test(dataProvider = "RegressionTestScripts")
	public void runTC_SF_ASAMERBrokerAccountsAdditionalActivity(String testInstance, ExecutionMode executionMode, Platform platform
