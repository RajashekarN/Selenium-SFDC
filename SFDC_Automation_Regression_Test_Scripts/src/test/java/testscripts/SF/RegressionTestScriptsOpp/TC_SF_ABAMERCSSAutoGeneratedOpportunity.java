 ...
 *
 */
public class TC_SF_ABAMERCSSAutoGeneratedOpportunity extends CRAFTTestCase
{
	@Test(groups= {"Regression","API","CSS","Opportunity","Generate"},dataProvider = "RegressionTestScripts")
	public void runTC_SF_ABAMERCSSAutoGeneratedOpportunity(String testInstance, ExecutionMode executionMode, Platform platform
