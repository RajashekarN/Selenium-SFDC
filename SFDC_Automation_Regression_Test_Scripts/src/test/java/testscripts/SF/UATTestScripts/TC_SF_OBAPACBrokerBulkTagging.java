...
public class TC_SF_OBAPACBrokerBulkTagging extends CRAFTTestCase {
	@Test(groups= {"UAT","API","APAC","Broker","Tagging"},dataProvider = "UATTestScripts")
	public void runTC_SF_OBAPACBrokerBulkTagging(String testInstance, ExecutionMode executionMode, Platform platform
			/*MobileToolName mobileToolName,
			MobileExecutionPlatform executionPlatform, String deviceName*/)
	{
		SeleniumTestParameters testParameters = new SeleniumTestParameters(currentScenario, currentTestcase);
		testParameters.setCurrentTestDescription("Test for validating the Bulk Tagging functionality for OBAPAC");
