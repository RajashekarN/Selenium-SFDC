...
public class TC_SF_OBEMEABrokerContactsHyperlink extends CRAFTTestCase {
	@Test(dataProvider = "RegressionTestScripts")
	public void runTC_SF_OBEMEABrokerContactsHyperlink(String testInstance, ExecutionMode executionMode, Platform platform
