...
public class TC_SF_OBEMEAOccupierClientCareContactsMarketingSegmentation extends CRAFTTestCase {
	@Test(dataProvider = "RegressionTestScripts")
	public void runTC_SF_OBEMEAOccupierClientCareContactsMarketingSegmentation(String testInstance, ExecutionMode executionMode, Platform platform
			/*MobileToolName mobileToolName,
			MobileExecutionPlatform executionPlatform, String deviceName*/)
	{
		SeleniumTestParameters testParameters = new SeleniumTestParameters(currentScenario, currentTestcase);
		testParameters.setCurrentTestDescription("Test for Validating the Contacts marketing segmentation fields for the Occupier Client care");
