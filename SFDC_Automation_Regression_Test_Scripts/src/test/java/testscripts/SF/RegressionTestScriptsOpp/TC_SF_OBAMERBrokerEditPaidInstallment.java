 ...
 *
 */
public class TC_SF_OBAMERBrokerEditPaidInstallment extends CRAFTTestCase
{
	@Test(groups= {"Regression","UI","Broker","Opportunity","Installment"},dataProvider = "RegressionTestScripts")
	public void runTC_SF_OBAMERBrokerEditPaidInstallment(String testInstance, ExecutionMode executionMode, Platform platform
