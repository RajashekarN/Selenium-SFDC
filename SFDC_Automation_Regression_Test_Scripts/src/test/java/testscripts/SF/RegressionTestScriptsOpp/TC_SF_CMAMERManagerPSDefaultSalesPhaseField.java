 ...
 *
 */
public class TC_SF_CMAMERManagerPSDefaultSalesPhaseField extends CRAFTTestCase
{
	@Test(groups= {"Regression","UI","Manager","Opportunity","Sales"},dataProvider = "RegressionTestScripts")
	public void runTC_SF_CMAMERManagerPSDefaultSalesPhaseField(String testInstance, ExecutionMode executionMode, Platform platform
