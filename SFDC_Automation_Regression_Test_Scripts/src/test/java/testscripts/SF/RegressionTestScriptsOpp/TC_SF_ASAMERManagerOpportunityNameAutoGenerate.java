 ...
 *
 */
public class TC_SF_ASAMERManagerOpportunityNameAutoGenerate extends CRAFTTestCase
{
	@Test(groups= {"Regression","API","Manager","Opportunity","Generate"},dataProvider = "RegressionTestScripts")
	public void runTC_SF_ASAMERManagerOpportunityNameAutoGenerate(String testInstance, ExecutionMode executionMode, Platform platform
