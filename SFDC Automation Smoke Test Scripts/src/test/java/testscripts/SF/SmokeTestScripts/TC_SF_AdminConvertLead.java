 ...
 *
 */
public class TC_SF_AdminConvertLead extends CRAFTTestCase
{
	@Test(dataProvider = "SmokeTestScripts")
	public void runTC_SF_AdminConvertLead(String testInstance, ExecutionMode executionMode, Platform platform
