...
public class TC_SF_VASEMEABrokerOpportunitiesAssignmentTypeField extends CRAFTTestCase {
	@Test(dataProvider = "RegressionTestScripts")
	public void runTC_SF_VASEMEABrokerOpportunitiesAssignmentTypeField(String testInstance, ExecutionMode executionMode, Platform platform
