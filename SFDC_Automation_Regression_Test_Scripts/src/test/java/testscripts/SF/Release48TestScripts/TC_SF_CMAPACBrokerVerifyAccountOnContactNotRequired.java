package testscripts.SF.Release48TestScripts;
...
import com.cognizant.framework.selenium.SeleniumTestParameters;
	...
	/**
	 * Test Script for validating the Primary Account on Contact is not required.
	 * 
	 * @author Swapna
	 *
	 */
	public class TC_SF_CMAPACBrokerVerifyAccountOnContactNotRequired extends CRAFTTestCase
	{
		@Test(groups= {"Regression","UI","Broker","Project Enquiries","Generate"},dataProvider = "RegressionTestScripts")
		public void runTC_SF_CMAPACBrokerVerifyAccountOnContactNotRequired(String testInstance, ExecutionMode executionMode, Platform platform
