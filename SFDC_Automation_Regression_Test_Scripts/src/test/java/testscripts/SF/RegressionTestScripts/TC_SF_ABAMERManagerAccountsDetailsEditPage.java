...
/**
 * Test Script for validating the Accounts Details Edit Page 
 * 
 * @author Ramya
 *
 */

public class TC_SF_ABAMERManagerAccountsDetailsEditPage extends CRAFTTestCase
{
	@Test(groups= {"REGRESSION","UI","Manager","Account","Edit"},dataProvider = "RegressionTestScripts")
	public void runTC_SF_ABAMERManagerAccountsDetailsEditPage(String testInstance, ExecutionMode executionMode, Platform platform
