...
public class TC_SF_CMAPACBrokerHomeVerifyingTabsOnHomePage extends CRAFTTestCase {
	@Test(dataProvider = "RegressionTestScripts")
	public void runTC_SF_CMAPACBrokerHomeVerifyingTabsOnHomePage(String testInstance, ExecutionMode executionMode, Platform platform
