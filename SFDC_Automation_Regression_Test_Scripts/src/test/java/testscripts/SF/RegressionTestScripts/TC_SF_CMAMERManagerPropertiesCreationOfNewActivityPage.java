...
/**
 * Test Script for for validating the creation of New Activity from a Manager Profile with Capital Markets
 * 
 * @author Ramya
 *
 */

public class TC_SF_CMAMERManagerPropertiesCreationOfNewActivityPage extends CRAFTTestCase
{
	@Test(groups= {"REGRESSION","UI","Manager","Property","Activity"},dataProvider = "RegressionTestScripts")
	public void runTC_SF_CMAMERManagerPropertiesCreationOfNewActivityPage(String testInstance, ExecutionMode executionMode, Platform platform
