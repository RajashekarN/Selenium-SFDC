...
/**
 * Validating the Lead sections
 * 
 * @author Vishnu
 *
 */

public class TC_SF_CMAPACManagerLeadsSectionValidation extends CRAFTTestCase {
	@Test(groups= {"UAT","API","Manager","Lead","Section"},dataProvider = "UATTestScripts")
	public void runTC_SF_CMAPACManagerLeadsSectionValidation(String testInstance, ExecutionMode executionMode, Platform platform
			/*MobileToolName mobileToolName,
			MobileExecutionPlatform executionPlatform, String deviceName*/)
	{
		SeleniumTestParameters testParameters = new SeleniumTestParameters(currentScenario, currentTestcase);
		testParameters.setCurrentTestDescription("Test for validating the Leads sections for CMAPAC");
