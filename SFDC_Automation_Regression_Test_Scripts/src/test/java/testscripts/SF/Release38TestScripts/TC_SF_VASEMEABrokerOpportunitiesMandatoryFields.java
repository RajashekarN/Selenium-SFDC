...
public class TC_SF_VASEMEABrokerOpportunitiesMandatoryFields extends CRAFTTestCase {
	@Test(dataProvider = "RegressionTestScripts")
	public void runTC_SF_VASEMEABrokerOpportunitiesMandatoryFields(String testInstance, ExecutionMode executionMode, Platform platform
