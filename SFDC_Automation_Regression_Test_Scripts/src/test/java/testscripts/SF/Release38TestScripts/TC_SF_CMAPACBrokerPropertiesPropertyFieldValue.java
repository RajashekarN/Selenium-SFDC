...
public class TC_SF_CMAPACBrokerPropertiesPropertyFieldValue extends CRAFTTestCase {
	@Test(dataProvider = "RegressionTestScripts")
	public void runTC_SF_CMAPACBrokerPropertiesPropertyFieldValue(String testInstance, ExecutionMode executionMode, Platform platform
