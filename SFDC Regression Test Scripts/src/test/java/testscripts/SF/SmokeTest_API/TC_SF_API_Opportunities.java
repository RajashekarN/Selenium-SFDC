 ...
 *
 */
public class TC_SF_API_Opportunities extends CRAFTTestCase
{
	@Test(dataProvider = "SmokeTestScripts")
	public void runTC_SF_API_Opportunities(String testInstance, ExecutionMode executionMode, Platform platform
