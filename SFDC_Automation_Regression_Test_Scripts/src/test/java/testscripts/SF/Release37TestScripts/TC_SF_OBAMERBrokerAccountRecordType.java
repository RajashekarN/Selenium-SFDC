 ...
 *
 */
public class TC_SF_OBAMERBrokerAccountRecordType extends CRAFTTestCase
{
	@Test(dataProvider = "RegressionTestScripts")
	public void runTC_SF_OBAMERBrokerAccountRecordType(String testInstance, ExecutionMode executionMode, Platform platform
