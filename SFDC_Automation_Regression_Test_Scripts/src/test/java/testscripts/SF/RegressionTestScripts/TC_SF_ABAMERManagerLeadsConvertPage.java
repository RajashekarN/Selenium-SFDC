...
public class TC_SF_ABAMERManagerLeadsConvertPage extends CRAFTTestCase
{
	@Test(groups= {"REGRESSION","API","Manager","Lead","Convert"},dataProvider = "RegressionTestScripts")
	public void runTC_SF_ABAMERManagerLeadsConvertPage(String testInstance, ExecutionMode executionMode, Platform platform
