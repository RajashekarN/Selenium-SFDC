 ...
 *
 */
public class TC_SF_ASAPACBrokerAdditionalActivityTypes extends CRAFTTestCase
{
	@Test(dataProvider = "RegressionTestScripts")
	public void runTC_SF_ASAPACBrokerAdditionalActivityTypes(String testInstance, ExecutionMode executionMode, Platform platform
