...
public class TC_SF_OBAMERManagerContactsPopulatingRequiredFieldsPage extends CRAFTTestCase
{
	@Test(groups= {"REGRESSION","API","Manager","Contact","Field"},dataProvider = "RegressionTestScripts")
	public void runTC_SF_OBAMERManagerContactsPopulatingRequiredFieldsPage(String testInstance, ExecutionMode executionMode, Platform platform
