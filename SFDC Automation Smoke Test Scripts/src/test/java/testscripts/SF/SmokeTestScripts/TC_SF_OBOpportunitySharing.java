...
public class TC_SF_OBOpportunitySharing extends CRAFTTestCase
{
	@Test(dataProvider = "SmokeTestScripts")
	public void runTC_SF_OBOpportunitySharing(String testInstance, ExecutionMode executionMode, Platform platform
