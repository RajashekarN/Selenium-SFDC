...
/**
 * Validating the Opportunities for the My Active Listings Filters
 * 
 * @author Ramya
 *
 */

public class TC_SF_CMAPACBrokerOpportunitiesActiveListingsFilters extends CRAFTTestCase {
	@Test(dataProvider = "RegressionTestScripts")
	public void runTC_SF_CMAPACBrokerOpportunitiesActiveListingsFilters(String testInstance, ExecutionMode executionMode, Platform platform
