...
public class TC_SF_CMAPACManagerLeadConversion extends CRAFTTestCase {
	@Test(groups= {"UAT","API","Manager","Lead","Conversion"},dataProvider = "UATTestScripts")
	public void runTC_SF_CMAPACManagerLeadConversion(String testInstance, ExecutionMode executionMode, Platform platform
			/*MobileToolName mobileToolName,
			MobileExecutionPlatform executionPlatform, String deviceName*/)
	{
		SeleniumTestParameters testParameters = new SeleniumTestParameters(currentScenario, currentTestcase);
		testParameters.setCurrentTestDescription("Test for validating the Lead Conversion for CMAPAC");
