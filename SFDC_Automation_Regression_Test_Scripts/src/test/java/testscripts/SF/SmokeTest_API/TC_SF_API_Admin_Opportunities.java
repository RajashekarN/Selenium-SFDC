 ...
 *
 */
public class TC_SF_API_AdminOpportunities extends CRAFTTestCase
{
	@Test(dataProvider = "SmokeTestScripts")
	public void runTC_SF_API_AdminOpportunities(String testInstance, ExecutionMode executionMode, Platform platform
