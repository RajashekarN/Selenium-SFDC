...
public class TC_SF_OBAMERAdminAccountsVerifySPOCs extends CRAFTTestCase
{
	@Test(groups= {"REGRESSION","UI","Admin","Account","SPOC"},dataProvider = "RegressionTestScripts")
	public void runTC_SF_OBAMERAdminAccountsVerifySPOCs(String testInstance, ExecutionMode executionMode, Platform platform
