...
public class TC_SF_OBAddPrivateNote extends CRAFTTestCase
{
	@Test(dataProvider = "SmokeTestScripts")
	public void runTC_SF_OBAddPrivateNote(String testInstance, ExecutionMode executionMode, Platform platform
