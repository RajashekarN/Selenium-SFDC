...
public class TC_SF_DAPACIDataUpdateApacGwsOppFields  extends CRAFTTestCase {
	
		@Test(groups= {"REGRESSION","API","Data Admin","Contact","Layout"},dataProvider = "RegressionTestScripts")
		public void runTC_SF_DAPACIDataUpdateApacGwsOppFields (String testInstance, ExecutionMode executionMode, Platform platform
				/*MobileToolName mobileToolName,
				MobileExecutionPlatform executionPlatform, String deviceName*/)
		{
			SeleniumTestParameters testParameters = new SeleniumTestParameters(currentScenario, currentTestcase);
			testParameters.setCurrentTestDescription("Validating the Lead source field on Opportunity object");
