...
public class TC_SF_CMEMEACSSContactsHyperlink extends CRAFTTestCase {
	@Test(dataProvider = "RegressionTestScripts")
	public void runTC_SF_CMEMEACSSContactsHyperlink(String testInstance, ExecutionMode executionMode, Platform platform
