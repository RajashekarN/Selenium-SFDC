...
/**
 * Validating the Opportunities for the create offer quick action drop down page
 * 
 * @author Ramya
 *
 */

public class TC_SF_CMAPACBrokerOpportunitiesCreateOfferPage extends CRAFTTestCase {
	@Test(dataProvider = "RegressionTestScripts")
	public void runTC_SF_CMAPACBrokerOpportunitiesCreateOfferPage(String testInstance, ExecutionMode executionMode, Platform platform
