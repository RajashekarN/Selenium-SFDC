 ...
 *
 */
public class TC_SF_OBAMERBrokerCampaignsTab extends CRAFTTestCase
{
	@Test(dataProvider = "RegressionTestScripts")
	public void runTC_SF_OBAMERBrokerCampaignsTab(String testInstance, ExecutionMode executionMode, Platform platform
