...
public class TC_SF_OBAPACCSSAccountsDetailsEditPage extends CRAFTTestCase
{
	@Test(groups= {"REGRESSION","UI","CSS","Account","Edit"},dataProvider = "RegressionTestScripts")
	public void runTC_SF_OBAPACCSSAccountsDetailsEditPage(String testInstance, ExecutionMode executionMode, Platform platform
