...
public class TC_SF_CMAMERBrokerContactsPopulatingRequiredFieldsPage extends CRAFTTestCase
{
	@Test(groups= {"REGRESSION","API","Broker","Contact","Fields"},dataProvider = "RegressionTestScripts")
	public void runTC_SF_CMAMERBrokerContactsPopulatingRequiredFieldsPage(String testInstance, ExecutionMode executionMode, Platform platform
