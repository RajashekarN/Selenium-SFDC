...
public class TC_SF_OBAMERManagerOpportunitySplitFunctionalityPage extends CRAFTTestCase
{
	@Test(groups= {"REGRESSION","UI","Manager","Opportunity","Split"},dataProvider = "RegressionTestScripts")
	public void runTC_SF_OBAMERManagerOpportunitySplitFunctionalityPage(String testInstance, ExecutionMode executionMode, Platform platform
			/*MobileToolName mobileToolName,
			MobileExecutionPlatform executionPlatform, String deviceName*/)
	{
		SeleniumTestParameters testParameters = new SeleniumTestParameters(currentScenario, currentTestcase);
		testParameters.setCurrentTestDescription("Test for validating the Split functionality");
