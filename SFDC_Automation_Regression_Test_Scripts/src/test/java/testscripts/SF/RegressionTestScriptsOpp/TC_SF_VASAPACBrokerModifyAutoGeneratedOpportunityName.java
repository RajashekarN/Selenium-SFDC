 ...
 *
 */
public class TC_SF_VASAPACBrokerModifyAutoGeneratedOpportunityName extends CRAFTTestCase
{
	@Test(groups= {"Regression","API","Broker","Opportunity","Generate"},dataProvider = "RegressionTestScripts")
	public void runTC_SF_VASAPACBrokerModifyAutoGeneratedOpportunityName(String testInstance, ExecutionMode executionMode, Platform platform
