...
import com.cognizant.framework.selenium.SeleniumTestParameters;
 ...
 public class TC_SF_DAPACIDataUomPicklistValues extends CRAFTTestCase {
	
		@Test(groups= {"REGRESSION","API","Data Admin","Opportunity","Layout"},dataProvider = "RegressionTestScripts")
		public void runTC_SF_DAPACIDataUomPicklistValues(String testInstance, ExecutionMode executionMode, Platform platform
				/*MobileToolName mobileToolName,
				MobileExecutionPlatform executionPlatform, String deviceName*/)
		{
			SeleniumTestParameters testParameters = new SeleniumTestParameters(currentScenario, currentTestcase);
			testParameters.setCurrentTestDescription("Validating the UOM pick list value for APAC DataAdmin profile");
