...
public class TC_SF_ABAMERManagerAccountsCustomActivityTimeline extends CRAFTTestCase
{
	@Test(dataProvider = "RegressionTestScripts")
	public void runTC_SF_ABAMERManagerAccountsCustomActivityTimeline(String testInstance, ExecutionMode executionMode, Platform platform
