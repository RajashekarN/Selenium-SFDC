...
public class TC_SF_OBEMEABrokerOpportunitiesPitchAdvisor extends CRAFTTestCase {
	@Test(dataProvider = "RegressionTestScripts")
	public void runTC_SF_OBEMEABrokerOpportunitiesPitchAdvisor(String testInstance, ExecutionMode executionMode, Platform platform
