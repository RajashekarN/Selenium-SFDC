...
/**
 * Validating the creation of Event on Lead
 * 
 * @author Vishnu
 *
 */

public class TC_SF_FDIGEMEAManagerEventonLead extends CRAFTTestCase {
	@Test(groups= {"UAT","API","France","Manager","Event","Lead"},dataProvider = "UATTestScripts")
	public void runTC_SF_FDIGEMEAManagerEventonLead(String testInstance, ExecutionMode executionMode, Platform platform
			/*MobileToolName mobileToolName,
			MobileExecutionPlatform executionPlatform, String deviceName*/)
	{
		SeleniumTestParameters testParameters = new SeleniumTestParameters(currentScenario, currentTestcase);
		testParameters.setCurrentTestDescription("Test for validating the creation of Event on Lead for FDIGEMEA");
