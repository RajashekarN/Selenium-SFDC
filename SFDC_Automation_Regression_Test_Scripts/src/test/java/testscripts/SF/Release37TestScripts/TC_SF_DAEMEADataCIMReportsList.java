 ...
 *
 */
public class TC_SF_DAEMEADataCIMReportsList extends CRAFTTestCase
{
	@Test(dataProvider = "RegressionTestScripts")
	public void runTC_SF_DAEMEADataCIMReportsList(String testInstance, ExecutionMode executionMode, Platform platform
