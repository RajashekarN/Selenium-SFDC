...
/**
 * Validating the Home Page Tabs for the APAC Capital Markets
 * 
 * @author Ramya
 *
 */

public class TC_SF_CMAPACManagerHomeVerifyingTabsOnHomePage extends CRAFTTestCase {
	@Test(dataProvider = "RegressionTestScripts")
	public void runTC_SF_CMAPACManagerHomeVerifyingTabsOnHomePage(String testInstance, ExecutionMode executionMode, Platform platform
