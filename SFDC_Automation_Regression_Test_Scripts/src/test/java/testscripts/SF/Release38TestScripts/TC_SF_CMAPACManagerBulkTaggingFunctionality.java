...
public class TC_SF_CMAPACManagerBulkTaggingFunctionality extends CRAFTTestCase {
	@Test(dataProvider = "RegressionTestScripts")
	public void runTC_SF_CMAPACManagerBulkTaggingFunctionality(String testInstance, ExecutionMode executionMode, Platform platform
