...
/**
 * Validating the Opportunities for the My Active Listings Kanban
 * 
 * @author Ramya
 *
 */

public class TC_SF_CMAPACBrokerOpportunitiesActiveListingsKanban extends CRAFTTestCase {
	@Test(dataProvider = "RegressionTestScripts")
	public void runTC_SF_CMAPACBrokerOpportunitiesActiveListingsKanban(String testInstance, ExecutionMode executionMode, Platform platform
