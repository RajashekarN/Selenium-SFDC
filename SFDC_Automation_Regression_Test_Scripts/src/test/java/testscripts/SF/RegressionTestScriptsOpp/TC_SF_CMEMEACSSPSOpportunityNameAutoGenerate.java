 ...
 *
 */
public class TC_SF_CMEMEACSSPSOpportunityNameAutoGenerate extends CRAFTTestCase
{
	@Test(groups= {"Regression","API","CSS","Opportunity","Generate"},dataProvider = "RegressionTestScripts")
	public void runTC_SF_CMEMEACSSPSOpportunityNameAutoGenerate(String testInstance, ExecutionMode executionMode, Platform platform
