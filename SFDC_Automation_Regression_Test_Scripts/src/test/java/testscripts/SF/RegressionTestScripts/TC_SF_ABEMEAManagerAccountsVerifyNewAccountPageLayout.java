...
public class TC_SF_ABEMEAManagerAccountsVerifyNewAccountPageLayout extends CRAFTTestCase
{
	@Test(groups= {"REGRESSION","API","Manager","Account","Page"},dataProvider = "RegressionTestScripts")
	public void runTC_SF_ABEMEAManagerAccountsVerifyNewAccountPageLayout(String testInstance, ExecutionMode executionMode, Platform platform
