...
public class TC_SF_CMAPACBrokerHomePageMarketingLists extends CRAFTTestCase {
	@Test(dataProvider = "RegressionTestScripts")
	public void runTC_SF_CMAPACBrokerHomePageMarketingLists(String testInstance, ExecutionMode executionMode, Platform platform
