...
public class TC_SF_CMAMERCSSContactsPopulatingRequiredFieldsPage extends CRAFTTestCase
{
	@Test(dataProvider = "RegressionTestScripts")
	public void runTC_SF_CMAMERCSSContactsPopulatingRequiredFieldsPage(String testInstance, ExecutionMode executionMode, Platform platform
