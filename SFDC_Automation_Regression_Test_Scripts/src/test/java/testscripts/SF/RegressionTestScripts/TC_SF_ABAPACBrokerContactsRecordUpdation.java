...
public class TC_SF_ABAPACBrokerContactsRecordUpdation extends CRAFTTestCase
{
	@Test(groups= {"REGRESSION","UI","Broker","Contact","Record"},dataProvider = "RegressionTestScripts")
	public void runTC_SF_ABAPACBrokerContactsRecordUpdation(String testInstance, ExecutionMode executionMode, Platform platform
