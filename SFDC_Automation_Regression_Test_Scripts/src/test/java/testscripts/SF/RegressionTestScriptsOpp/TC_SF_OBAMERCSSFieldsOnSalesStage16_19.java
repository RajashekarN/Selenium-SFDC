 ...
 *
 */
public class TC_SF_OBAMERCSSFieldsOnSalesStage16_19 extends CRAFTTestCase
{
	@Test(groups= {"Regression","UI","CSS","Opportunity","Sales"},dataProvider = "RegressionTestScripts")
	public void runTC_SF_OBAMERCSSFieldsOnSalesStage16_19(String testInstance, ExecutionMode executionMode, Platform platform
