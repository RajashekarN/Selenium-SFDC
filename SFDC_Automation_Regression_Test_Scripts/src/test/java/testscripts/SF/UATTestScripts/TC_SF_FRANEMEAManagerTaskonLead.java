...
public class TC_SF_FRANEMEAManagerTaskonLead extends CRAFTTestCase {
	@Test(groups= {"UAT","API","France","Manager","Lead","Task"},dataProvider = "UATTestScripts")
	public void runTC_SF_FRANEMEAManagerTaskonLead(String testInstance, ExecutionMode executionMode, Platform platform
			/*MobileToolName mobileToolName,
			MobileExecutionPlatform executionPlatform, String deviceName*/)
	{
		SeleniumTestParameters testParameters = new SeleniumTestParameters(currentScenario, currentTestcase);
		testParameters.setCurrentTestDescription("Test for validating the creation of Task on Leads FRANEMEA");
