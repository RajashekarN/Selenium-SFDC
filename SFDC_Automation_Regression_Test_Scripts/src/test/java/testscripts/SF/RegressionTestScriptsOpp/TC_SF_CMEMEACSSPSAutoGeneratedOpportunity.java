 ...
 *
 */
public class TC_SF_CMEMEACSSPSAutoGeneratedOpportunity extends CRAFTTestCase
{
	@Test(groups= {"Regression","API","CSS","Opportunity","Generate"},dataProvider = "RegressionTestScripts")
	public void runTC_SF_CMEMEACSSPSAutoGeneratedOpportunity(String testInstance, ExecutionMode executionMode, Platform platform
