 ...
 *
 */
public class TC_SF_OBAMERManagerOpportunityNameAutoGenerate extends CRAFTTestCase
{
	@Test(groups= {"Regression","API","Manager","Opportunity","Generate"},dataProvider = "RegressionTestScripts")
	public void runTC_SF_OBAMERManagerOpportunityNameAutoGenerate(String testInstance, ExecutionMode executionMode, Platform platform
			/*MobileToolName mobileToolName,
			MobileExecutionPlatform executionPlatform, String deviceName*/)
	{
		SeleniumTestParameters testParameters = new SeleniumTestParameters(currentScenario, currentTestcase);
		testParameters.setCurrentTestDescription("Test validating the Opportunity Auto generate name modification");
