...
/**
 * Test Script for validating the Opportunity sales phase field
 * 
 * @author Vishnuvardhan
 *
 */
public class TC_SF_CMAMERManagerDSFDefaultSalesPhaseField extends CRAFTTestCase
{
	@Test(groups= {"Regression","UI","Manager","Opportunity","Sales"},dataProvider = "RegressionTestScripts")
	public void runTC_SF_CMAMERManagerDSFDefaultSalesPhaseField(String testInstance, ExecutionMode executionMode, Platform platform
			/*MobileToolName mobileToolName,
			MobileExecutionPlatform executionPlatform, String deviceName*/)
	{
		SeleniumTestParameters testParameters = new SeleniumTestParameters(currentScenario, currentTestcase);
		testParameters.setCurrentTestDescription("Test validating the Opportunity sales phase field");
