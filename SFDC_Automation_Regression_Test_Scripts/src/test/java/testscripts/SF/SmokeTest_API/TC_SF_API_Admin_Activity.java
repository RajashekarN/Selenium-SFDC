 ...
 *
 */
public class TC_SF_API_Admin_Activity extends CRAFTTestCase
{
	@Test(groups= {"SMOKE","API","Admin","Activity"},dataProvider = "SmokeTestScripts")
			...
			MobileExecutionPlatform executionPlatform, String deviceName*/)
	{
		...
		testParameters.setCurrentTestDescription("Test API Activity create");
