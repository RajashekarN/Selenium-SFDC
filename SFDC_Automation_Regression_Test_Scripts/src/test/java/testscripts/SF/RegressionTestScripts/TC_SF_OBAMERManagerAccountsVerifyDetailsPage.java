...
/**
 * Test Script for validating the Accounts Page
 * 
 * @author Ramya
 *
 */

public class TC_SF_OBAMERManagerAccountsVerifyDetailsPage extends CRAFTTestCase
{
	@Test(groups= {"REGRESSION","UI","Manager","Account","Detail"},dataProvider = "RegressionTestScripts")
	public void runTC_SF_OBAMERManagerAccountsVerifyDetailsPage(String testInstance, ExecutionMode executionMode, Platform platform
