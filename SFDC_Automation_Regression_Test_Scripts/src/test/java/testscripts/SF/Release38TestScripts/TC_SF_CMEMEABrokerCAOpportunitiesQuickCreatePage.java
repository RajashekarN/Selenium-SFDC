...
public class TC_SF_CMEMEABrokerCAOpportunitiesQuickCreatePage extends CRAFTTestCase {
	@Test(dataProvider = "RegressionTestScripts")
	public void runTC_SF_CMEMEABrokerCAOpportunitiesQuickCreatePage(String testInstance, ExecutionMode executionMode, Platform platform
