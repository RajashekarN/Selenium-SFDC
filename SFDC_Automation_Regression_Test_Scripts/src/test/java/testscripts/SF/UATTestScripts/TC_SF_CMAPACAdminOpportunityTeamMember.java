...
/**
 * Validating the validating the Opportunity Team Member functionality
 * 
 * @author Vishnu
 *
 */

public class TC_SF_CMAPACAdminOpportunityTeamMember extends CRAFTTestCase {
	@Test(groups= {"UAT","UI","Admin","Opportunity"},dataProvider = "UATTestScripts")
			...
			MobileExecutionPlatform executionPlatform, String deviceName*/)
	{
		...
		testParameters.setCurrentTestDescription("Test for validating validating the Opportunity Team Member functionality for CMAPAC");
