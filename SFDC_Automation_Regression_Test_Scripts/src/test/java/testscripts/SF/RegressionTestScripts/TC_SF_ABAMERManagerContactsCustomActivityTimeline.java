...
public class TC_SF_ABAMERManagerContactsCustomActivityTimeline extends CRAFTTestCase
{
	@Test(dataProvider = "RegressionTestScripts")
	public void runTC_SF_ABAMERManagerContactsCustomActivityTimeline(String testInstance, ExecutionMode executionMode, Platform platform
