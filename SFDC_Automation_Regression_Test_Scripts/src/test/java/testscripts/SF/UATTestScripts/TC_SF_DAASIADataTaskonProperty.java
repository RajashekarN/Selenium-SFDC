...
/**
 * Validating the Task on Property
 * 
 * @author Vishnu
 *
 */

public class TC_SF_DAASIADataTaskonProperty extends CRAFTTestCase{
	@Test(groups= {"UAT","UI","Data","Property","Task"},dataProvider = "UATTestScripts")
	public void runTC_SF_DAASIADataTaskonProperty(String testInstance, ExecutionMode executionMode, Platform platform
			/*MobileToolName mobileToolName,
			MobileExecutionPlatform executionPlatform, String deviceName*/)
	{
		SeleniumTestParameters testParameters = new SeleniumTestParameters(currentScenario, currentTestcase);
		testParameters.setCurrentTestDescription("Test for the validating Task on Property");
