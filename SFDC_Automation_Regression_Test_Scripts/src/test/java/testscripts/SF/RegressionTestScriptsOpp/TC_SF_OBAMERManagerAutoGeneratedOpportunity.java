 ...
 *
 */
public class TC_SF_OBAMERManagerAutoGeneratedOpportunity extends CRAFTTestCase
{
	@Test(groups= {"Regression","API","Manager","Opportunity","Generate"},dataProvider = "RegressionTestScripts")
	public void runTC_SF_OBAMERManagerAutoGeneratedOpportunity(String testInstance, ExecutionMode executionMode, Platform platform
