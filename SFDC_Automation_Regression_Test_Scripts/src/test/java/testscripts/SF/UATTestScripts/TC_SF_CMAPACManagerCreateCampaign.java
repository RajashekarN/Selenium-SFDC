...
/**
 * Validating the creation of Campaign
 * 
 * @author Vishnu
 *
 */
...
public class TC_SF_CMAPACManagerCreateCampaign extends CRAFTTestCase {
	@Test(groups= {"UAT","API","Manager","Campaign"},dataProvider = "UATTestScripts")
			...
			MobileExecutionPlatform executionPlatform, String deviceName*/)
	{
		...
		testParameters.setCurrentTestDescription("Test for validating the creation of Campaign for CMAPAC");
