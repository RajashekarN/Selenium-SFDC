...
/**
 * Test Script for validating the sales phase field
 * 
 * @author Vishnuvardhan
 *
 */
public class TC_SF_CMAMERBrokerDSFDefaultSalesPhaseField extends CRAFTTestCase
{
	@Test(groups= {"Regression","UI","Broker","Opportunity","Sales"},dataProvider = "RegressionTestScripts")
	public void runTC_SF_CMAMERBrokerDSFDefaultSalesPhaseField(String testInstance, ExecutionMode executionMode, Platform platform
