 ...
 *
 */
public class TC_SF_OBOpportunitySplit extends CRAFTTestCase
{
	@Test(dataProvider = "SmokeTestScripts")
	public void runTC_SF_OBOpportunitySplit(String testInstance, ExecutionMode executionMode, Platform platform
