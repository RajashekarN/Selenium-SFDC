 ...
 *
 */
public class TC_SF_CMAMERBrokerSalesStage08_09 extends CRAFTTestCase
{
	@Test(groups= {"Regression","UI","Broker","Opportunity","Sales"},dataProvider = "RegressionTestScripts")
	public void runTC_SF_CMAMERBrokerSalesStage08_09(String testInstance, ExecutionMode executionMode, Platform platform
