...
public class TC_SF_FDIGEMEADataOpportunitiesLeadAndReasonField extends CRAFTTestCase
{
	@Test(groups= {"REGRESSION","API","DataAdmin","Opportunity","PickListValues"},dataProvider = "RegressionTestScripts")
	public void runTC_SF_FDIGEMEADataOpportunitiesLeadAndReasonField(String testInstance, ExecutionMode executionMode, Platform platform
			/*MobileToolName mobileToolName,
			MobileExecutionPlatform executionPlatform, String deviceName*/)
	{
		SeleniumTestParameters testParameters = new SeleniumTestParameters(currentScenario, currentTestcase);
		testParameters.setCurrentTestDescription("Test Script for validating the Lead and Reason field values");
