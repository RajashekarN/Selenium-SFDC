...
public class TC_SF_DAPACIDataLeadAddCampaign extends CRAFTTestCase {
	@Test(groups= {"UAT","API","DataAdmin","Lead","Campaign"},dataProvider = "UATTestScripts")
	public void runTC_SF_DAPACIDataLeadAddCampaign(String testInstance, ExecutionMode executionMode, Platform platform
