...
/**
 * Test Script for validating the fields on pages 
 * 
 * @author Vishnuvardhan
 *
 */
public class TC_SF_API_PageValidations extends CRAFTTestCase
{
	@Test(dataProvider = "SmokeTestScripts")
	public void runTC_SF_API_PageValidations(String testInstance, ExecutionMode executionMode, Platform platform
			/*MobileToolName mobileToolName,
			MobileExecutionPlatform executionPlatform, String deviceName*/)
	{
		SeleniumTestParameters testParameters = new SeleniumTestParameters(currentScenario, currentTestcase);
		testParameters.setCurrentTestDescription("Test API for validating the fields on Pages");
