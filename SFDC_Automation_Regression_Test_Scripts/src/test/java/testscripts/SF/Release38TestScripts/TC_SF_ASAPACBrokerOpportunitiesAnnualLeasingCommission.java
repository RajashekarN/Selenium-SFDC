...
public class TC_SF_ASAPACBrokerOpportunitiesAnnualLeasingCommission extends CRAFTTestCase {
	@Test(dataProvider = "RegressionTestScripts")
	public void runTC_SF_ASAPACBrokerOpportunitiesAnnualLeasingCommission(String testInstance, ExecutionMode executionMode, Platform platform
