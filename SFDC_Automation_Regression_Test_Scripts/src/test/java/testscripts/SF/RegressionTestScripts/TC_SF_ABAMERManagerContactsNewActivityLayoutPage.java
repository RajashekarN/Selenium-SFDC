...
public class TC_SF_ABAMERManagerContactsNewActivityLayoutPage extends CRAFTTestCase
{
	@Test(groups= {"REGRESSION","UI","Manager","Contact","Activity"},dataProvider = "RegressionTestScripts")
	public void runTC_SF_ABAMERManagerContactsNewActivityLayoutPage(String testInstance, ExecutionMode executionMode, Platform platform
