...
public class TC_SF_ASEMEABrokerOpportunitiesOpportunityName extends CRAFTTestCase {
	@Test(dataProvider = "RegressionTestScripts")
	public void runTC_SF_ASEMEABrokerOpportunitiesOpportunityName(String testInstance, ExecutionMode executionMode, Platform platform
