...
/**
 * Validating the Account activity
 * 
 * @author Cognizant
 *
 */

public class TC_SF_FRANEMEAManagerAccountActivity extends CRAFTTestCase {
	@Test(groups= {"UAT","API","France","Manager","Account","Task"},dataProvider = "UATTestScripts")
	public void runTC_SF_FRANEMEAManagerAccountActivity(String testInstance, ExecutionMode executionMode, Platform platform
			/*MobileToolName mobileToolName,
			MobileExecutionPlatform executionPlatform, String deviceName*/)
	{
		SeleniumTestParameters testParameters = new SeleniumTestParameters(currentScenario, currentTestcase);
		testParameters.setCurrentTestDescription("Test for validating the Account activity for FRANEMEA");
