...
/**
 * Validating the Opportunity Activity Task and Event functionality
 * 
 * @author Vishnu
 *
 */
...
public class TC_SF_CMAPACAdminOpportunityActivityTaskEvent extends CRAFTTestCase {
			...
			MobileExecutionPlatform executionPlatform, String deviceName*/)
	{
		...
		testParameters.setCurrentTestDescription("Test for the Opportunity Activity Task and Event functionality for CMAPAC");
