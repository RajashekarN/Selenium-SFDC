...
public class TC_SF_OBAMERBrokerPropertiesVerifyCustomActivityTimeline extends CRAFTTestCase
{
	@Test(dataProvider = "RegressionTestScripts")
	public void runTC_SF_OBAMERBrokerPropertiesVerifyCustomActivityTimeline(String testInstance, ExecutionMode executionMode, Platform platform
