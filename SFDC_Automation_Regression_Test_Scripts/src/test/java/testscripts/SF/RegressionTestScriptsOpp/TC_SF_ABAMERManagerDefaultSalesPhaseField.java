 ...
 *
 */
public class TC_SF_ABAMERManagerDefaultSalesPhaseField extends CRAFTTestCase
{
	@Test(groups= {"Regression","UI","Manager","Opportunity","Sales"},dataProvider = "RegressionTestScripts")
	public void runTC_SF_ABAMERManagerDefaultSalesPhaseField(String testInstance, ExecutionMode executionMode, Platform platform
