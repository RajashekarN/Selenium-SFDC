...
public class TC_SF_CMEMEAManagerIPActiveOpportunities extends CRAFTTestCase {
	@Test(dataProvider = "RegressionTestScripts")
	public void runTC_SF_CMEMEAManagerIPActiveOpportunities(String testInstance, ExecutionMode executionMode, Platform platform
