...
/**
 * Test Script for validating the edit paid installment
 * 
 * @author Vishnuvardhan
 *
 */
public class TC_SF_ABAMERBrokerEditPaidInstallment extends CRAFTTestCase
{
	@Test(groups= {"Regression","UI","Broker","Opportunity","Installment"},dataProvider = "RegressionTestScripts")
	public void runTC_SF_ABAMERBrokerEditPaidInstallment(String testInstance, ExecutionMode executionMode, Platform platform
			/*MobileToolName mobileToolName,
			MobileExecutionPlatform executionPlatform, String deviceName*/)
	{
		SeleniumTestParameters testParameters = new SeleniumTestParameters(currentScenario, currentTestcase);
		testParameters.setCurrentTestDescription("Test validating the edit paid installment");
