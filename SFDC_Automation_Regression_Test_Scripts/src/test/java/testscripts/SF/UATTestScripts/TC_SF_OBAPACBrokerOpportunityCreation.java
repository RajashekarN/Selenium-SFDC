...
/**
 * Validating the Opportunity creation
 * 
 * @author Vishnu
 *
 */

public class TC_SF_OBAPACBrokerOpportunityCreation extends CRAFTTestCase {
	@Test(groups= {"UAT","API","APAC","Broker","Opportunity"},dataProvider = "UATTestScripts")
	public void runTC_SF_OBAPACBrokerOpportunityCreation(String testInstance, ExecutionMode executionMode, Platform platform
			/*MobileToolName mobileToolName,
			MobileExecutionPlatform executionPlatform, String deviceName*/)
	{
		SeleniumTestParameters testParameters = new SeleniumTestParameters(currentScenario, currentTestcase);
		testParameters.setCurrentTestDescription("Test for validating the Opportunity creation for OBAPAC");
