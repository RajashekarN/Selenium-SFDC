 ...
 *
 */
public class TC_SF_DAEMEADataAccountRecordType extends CRAFTTestCase
{
	@Test(dataProvider = "RegressionTestScripts")
	public void runTC_SF_DAEMEADataAccountRecordType(String testInstance, ExecutionMode executionMode, Platform platform
