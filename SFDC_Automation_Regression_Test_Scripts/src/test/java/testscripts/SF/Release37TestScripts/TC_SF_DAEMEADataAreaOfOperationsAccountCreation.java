 ...
 *
 */
public class TC_SF_DAEMEADataAreaOfOperationsAccountCreation extends CRAFTTestCase
{
	@Test(dataProvider = "RegressionTestScripts")
	public void runTC_SF_DAEMEADataAreaOfOperationsAccountCreation(String testInstance, ExecutionMode executionMode, Platform platform
