...
public class TC_SF_CMAPACCSSAccountsDetailsEditPage extends CRAFTTestCase
{
	@Test(groups= {"REGRESSION","UI","CSS","Account","Edit"},dataProvider = "RegressionTestScripts")
	public void runTC_SF_CMAPACCSSAccountsDetailsEditPage(String testInstance, ExecutionMode executionMode, Platform platform
