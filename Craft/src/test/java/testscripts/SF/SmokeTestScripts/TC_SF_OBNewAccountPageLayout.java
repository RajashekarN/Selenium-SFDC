...
public class TC_SF_OBNewAccountPageLayout extends CRAFTTestCase
{
	@Test(dataProvider = "SmokeTestScripts")
	public void runTC_SF_OBNewAccountPageLayout(String testInstance, ExecutionMode executionMode, Platform platform
