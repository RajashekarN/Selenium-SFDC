...
public class TC_SF_CMAMERManagerContactsPopulatingAllFields extends CRAFTTestCase
{
	@Test(groups= {"REGRESSION","API","Manager","Contact","Fields"},dataProvider = "RegressionTestScripts")
	public void runTC_SF_CMAMERManagerContactsPopulatingAllFields(String testInstance, ExecutionMode executionMode, Platform platform
