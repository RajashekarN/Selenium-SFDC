 ...
 *
 */
public class TC_SF_CMAMERBrokerSupporCustomtLinks extends CRAFTTestCase
{
	@Test(groups= {"REGRESSION","UI","Broker","Suppor","Customt"},dataProvider = "RegressionTestScripts")
	public void runTC_SF_CMAMERBrokerSupporCustomtLinks(String testInstance, ExecutionMode executionMode, Platform platform
			/*MobileToolName mobileToolName,
			MobileExecutionPlatform executionPlatform, String deviceName*/)
	{
		SeleniumTestParameters testParameters = new SeleniumTestParameters(currentScenario, currentTestcase);
		testParameters.setCurrentTestDescription("Test for Custom Support links");
