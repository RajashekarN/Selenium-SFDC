...
public class TC_SF_CMAMERBrokerAccountsDetailsEditPage extends CRAFTTestCase
{
	@Test(groups= {"REGRESSION","UI","Broker","Account","Edit"},dataProvider = "RegressionTestScripts")
	public void runTC_SF_CMAMERBrokerAccountsDetailsEditPage(String testInstance, ExecutionMode executionMode, Platform platform
