...
public class TC_SF_OBCreateLead extends CRAFTTestCase
{
	@Test(dataProvider = "SmokeTestScripts")
	public void runTC_SF_OBCreateLead(String testInstance, ExecutionMode executionMode, Platform platform
