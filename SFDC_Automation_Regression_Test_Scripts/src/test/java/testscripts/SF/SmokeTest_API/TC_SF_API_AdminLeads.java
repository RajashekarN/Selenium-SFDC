 ...
 *
 */
public class TC_SF_API_AdminLeads extends CRAFTTestCase
{
	@Test(dataProvider = "SmokeTestScripts")
	public void runTC_SF_API_AdminLeads(String testInstance, ExecutionMode executionMode, Platform platform
