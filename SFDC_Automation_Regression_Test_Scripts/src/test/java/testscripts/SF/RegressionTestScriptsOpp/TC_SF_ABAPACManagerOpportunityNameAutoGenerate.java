 ...
 *
 */
public class TC_SF_ABAPACManagerOpportunityNameAutoGenerate extends CRAFTTestCase
{
	@Test(groups= {"Regression","API","Manager","Opportunity","Generate"},dataProvider = "RegressionTestScripts")
	public void runTC_SF_ABAPACManagerOpportunityNameAutoGenerate(String testInstance, ExecutionMode executionMode, Platform platform
