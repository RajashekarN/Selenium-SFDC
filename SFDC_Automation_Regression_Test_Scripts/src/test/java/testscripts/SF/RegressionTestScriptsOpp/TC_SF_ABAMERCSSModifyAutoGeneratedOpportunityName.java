 ...
 *
 */
public class TC_SF_ABAMERCSSModifyAutoGeneratedOpportunityName extends CRAFTTestCase
{
	@Test(groups= {"Regression","API","CSS","Opportunity","Generate"},dataProvider = "RegressionTestScripts")
	public void runTC_SF_ABAMERCSSModifyAutoGeneratedOpportunityName(String testInstance, ExecutionMode executionMode, Platform platform
			/*MobileToolName mobileToolName,
			MobileExecutionPlatform executionPlatform, String deviceName*/)
	{
		SeleniumTestParameters testParameters = new SeleniumTestParameters(currentScenario, currentTestcase);
		testParameters.setCurrentTestDescription("Test validating the Auto generate name");
