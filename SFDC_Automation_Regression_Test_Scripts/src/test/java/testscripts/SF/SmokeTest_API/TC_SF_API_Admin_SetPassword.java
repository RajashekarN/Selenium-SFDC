...
/**
 * Test Script for setting up the new password
 * 
 * @author Vishnuvardhan
 *
 */
public class TC_SF_API_Admin_SetPassword extends CRAFTTestCase
{
			...
			MobileExecutionPlatform executionPlatform, String deviceName*/)
	{
		...
		testParameters.setCurrentTestDescription("Test API to set the new password");
