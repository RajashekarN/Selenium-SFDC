...
public class TC_SF_OBAMERCSSLeadsConvertPage extends CRAFTTestCase
{
	@Test(groups= {"REGRESSION","API","CSS","Lead","Convert"},dataProvider = "RegressionTestScripts")
	public void runTC_SF_OBAMERCSSLeadsConvertPage(String testInstance, ExecutionMode executionMode, Platform platform
