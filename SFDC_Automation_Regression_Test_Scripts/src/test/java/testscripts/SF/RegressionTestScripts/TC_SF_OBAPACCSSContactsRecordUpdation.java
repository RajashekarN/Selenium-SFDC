...
public class TC_SF_OBAPACCSSContactsRecordUpdation extends CRAFTTestCase
{
	@Test(groups= {"REGRESSION","UI","CSS","Contact","Record"},dataProvider = "RegressionTestScripts")
	public void runTC_SF_OBAPACCSSContactsRecordUpdation(String testInstance, ExecutionMode executionMode, Platform platform
