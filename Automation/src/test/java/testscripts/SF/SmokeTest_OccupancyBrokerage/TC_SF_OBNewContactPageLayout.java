...
public class TC_SF_OBNewContactPageLayout extends TestCase
{
	...
	public void runTC_SF_OBNewContactPageLayout(@Optional("Sandbox") String environment)
	{
		testParameters.setCurrentTestDescription("Test for valdiating the Account Name in the New Contacts page layout");
