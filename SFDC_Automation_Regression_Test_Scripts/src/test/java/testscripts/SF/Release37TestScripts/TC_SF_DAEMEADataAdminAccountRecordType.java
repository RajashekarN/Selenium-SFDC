 ...
 *
 */
public class TC_SF_DAEMEADataAdminAccountRecordType extends CRAFTTestCase
{
	@Test(dataProvider = "RegressionTestScripts")
	public void runTC_SF_DAEMEADataAdminAccountRecordType(String testInstance, ExecutionMode executionMode, Platform platform
