 ...
 *
 */
public class TC_SF_ASAPACBrokerAutoGeneratedOpportunity extends CRAFTTestCase
{
	@Test(groups= {"Regression","API","Broker","Opportunity","Generate"},dataProvider = "RegressionTestScripts")
	public void runTC_SF_ASAPACBrokerAutoGeneratedOpportunity(String testInstance, ExecutionMode executionMode, Platform platform
