 ...
 *
 */
public class TC_SF_ManagerLogin extends CRAFTTestCase
{
	@Test(dataProvider = "SmokeTestScripts")
	public void runTC_SF_ManagerLogin(String testInstance, ExecutionMode executionMode, Platform platform
