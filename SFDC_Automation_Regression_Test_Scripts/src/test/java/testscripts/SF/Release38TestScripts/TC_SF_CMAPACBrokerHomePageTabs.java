...
public class TC_SF_CMAPACBrokerHomePageTabs extends CRAFTTestCase {
	@Test(dataProvider = "RegressionTestScripts")
	public void runTC_SF_CMAPACBrokerHomePageTabs(String testInstance, ExecutionMode executionMode, Platform platform
