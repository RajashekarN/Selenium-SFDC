...
/**
 * Validating the Budget/ Target Edit
 * 
 * @author Vishnu
 *
 */

public class TC_SF_CMAPACManagerBudgetEdit extends CRAFTTestCase {
	@Test(groups= {"UAT","API","Manager","Budget"},dataProvider = "UATTestScripts")
	public void runTC_SF_CMAPACManagerBudgetEdit(String testInstance, ExecutionMode executionMode, Platform platform
			/*MobileToolName mobileToolName,
			MobileExecutionPlatform executionPlatform, String deviceName*/)
	{
		SeleniumTestParameters testParameters = new SeleniumTestParameters(currentScenario, currentTestcase);
		testParameters.setCurrentTestDescription("Test for validating the Budget/ Target Edit for CMAPAC");
