...
public class TC_SF_FDIGEMEAManagerTaskonContact extends CRAFTTestCase {
	@Test(groups= {"UAT","API","France","Manager","Contact","Task"},dataProvider = "UATTestScripts")
	public void runTC_SF_FDIGEMEAManagerTaskonContact(String testInstance, ExecutionMode executionMode, Platform platform
