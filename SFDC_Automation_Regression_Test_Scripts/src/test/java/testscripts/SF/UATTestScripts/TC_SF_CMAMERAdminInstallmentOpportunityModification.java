...
/**
 * Validating the Opportunity Installment modification
 * 
 * @author Vishnu
 *
 */
...
public class TC_SF_CMAMERAdminInstallmentOpportunityModification extends CRAFTTestCase {
			...
			MobileExecutionPlatform executionPlatform, String deviceName*/)
	{
		...
		testParameters.setCurrentTestDescription("Test for validating the Opportunity Installment modification for CMAMER");
