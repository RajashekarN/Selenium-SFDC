...
public class TC_SF_CMAMERBrokerContactsRecordUpdation extends CRAFTTestCase
{
	@Test(groups= {"REGRESSION","UI","Broker","Contact","Record"},dataProvider = "RegressionTestScripts")
	public void runTC_SF_CMAMERBrokerContactsRecordUpdation(String testInstance, ExecutionMode executionMode, Platform platform
