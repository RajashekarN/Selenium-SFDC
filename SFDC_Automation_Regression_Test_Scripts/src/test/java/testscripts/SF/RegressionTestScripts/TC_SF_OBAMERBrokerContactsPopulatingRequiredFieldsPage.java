...
public class TC_SF_OBAMERBrokerContactsPopulatingRequiredFieldsPage extends CRAFTTestCase
{
	@Test(groups= {"REGRESSION","API","Broker","Contact","Field"},dataProvider = "RegressionTestScripts")
	public void runTC_SF_OBAMERBrokerContactsPopulatingRequiredFieldsPage(String testInstance, ExecutionMode executionMode, Platform platform
