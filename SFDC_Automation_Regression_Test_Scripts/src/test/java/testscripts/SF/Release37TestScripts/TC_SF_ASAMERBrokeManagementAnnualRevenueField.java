...
public class TC_SF_ASAMERBrokerOpportunitiesVerifyManagementAnnualRevenueField extends CRAFTTestCase {
	@Test(dataProvider = "RegressionTestScripts")
	public void runTC_SF_ASAMERBrokerOpportunitiesVerifyManagementAnnualRevenueField(String testInstance, ExecutionMode executionMode, Platform platform
