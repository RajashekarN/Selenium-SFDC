...
public class TC_SF_AUCAPACBrokerOpportunitiesMandatoryFields extends CRAFTTestCase {
	@Test(dataProvider = "RegressionTestScripts")
	public void runTC_SF_AUCAPACBrokerOpportunitiesMandatoryFields(String testInstance, ExecutionMode executionMode, Platform platform
