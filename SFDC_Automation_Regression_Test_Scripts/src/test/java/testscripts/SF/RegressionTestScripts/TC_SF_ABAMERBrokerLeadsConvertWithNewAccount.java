...
/**
 * Test Script for validating the Lead convert with the Account for the Agency Broker
 * 
 * @author Ramya
 *
 */

public class TC_SF_ABAMERBrokerLeadsConvertWithNewAccount extends CRAFTTestCase
{
	@Test(groups= {"REGRESSION","API","Broker","Lead","Convert"},dataProvider = "RegressionTestScripts")
	public void runTC_SF_ABAMERBrokerLeadsConvertWithNewAccount(String testInstance, ExecutionMode executionMode, Platform platform
			/*MobileToolName mobileToolName,
			MobileExecutionPlatform executionPlatform, String deviceName*/)
	{
		SeleniumTestParameters testParameters = new SeleniumTestParameters(currentScenario, currentTestcase);
		testParameters.setCurrentTestDescription("Test Script for validating the Lead convert with the Account for the Agency Broker");
