...
public class TC_SF_AdminOpportunitySharing extends CRAFTTestCase
{
	@Test(dataProvider = "SmokeTestScripts")
	public void runTC_SF_AdminOpportunitySharing(String testInstance, ExecutionMode executionMode, Platform platform
