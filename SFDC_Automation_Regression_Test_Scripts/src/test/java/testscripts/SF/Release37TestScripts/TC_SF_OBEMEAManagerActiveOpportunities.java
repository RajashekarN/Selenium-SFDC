...
public class TC_SF_OBEMEAManagerActiveOpportunities extends CRAFTTestCase {
	@Test(dataProvider = "RegressionTestScripts")
	public void runTC_SF_OBEMEAManagerActiveOpportunities(String testInstance, ExecutionMode executionMode, Platform platform
