...
public class TC_SF_CMAMERCSSContactsRecordUpdation extends CRAFTTestCase
{
	@Test(groups= {"REGRESSION","UI","CSS","Contact","Record"},dataProvider = "RegressionTestScripts")
	public void runTC_SF_CMAMERCSSContactsRecordUpdation(String testInstance, ExecutionMode executionMode, Platform platform
