...
public class TC_SF_VASEMEABrokerOpportunitiesQuickCreatePage extends CRAFTTestCase {
	@Test(dataProvider = "RegressionTestScripts")
	public void runTC_SF_VASEMEABrokerOpportunitiesQuickCreatePage(String testInstance, ExecutionMode executionMode, Platform platform
