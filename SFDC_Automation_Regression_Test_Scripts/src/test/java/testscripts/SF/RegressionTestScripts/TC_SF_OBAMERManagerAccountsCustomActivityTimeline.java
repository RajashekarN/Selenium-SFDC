...
public class TC_SF_OBAMERManagerAccountsCustomActivityTimeline extends CRAFTTestCase
{
	@Test(groups= {"REGRESSION","UI","Manager","Account","Activity"},dataProvider = "RegressionTestScripts")
	public void runTC_SF_OBAMERManagerAccountsCustomActivityTimeline(String testInstance, ExecutionMode executionMode, Platform platform
