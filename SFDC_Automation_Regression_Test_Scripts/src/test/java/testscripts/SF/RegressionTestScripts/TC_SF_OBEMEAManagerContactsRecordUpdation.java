...
public class TC_SF_OBEMEAManagerContactsRecordUpdation extends CRAFTTestCase
{
	@Test(dataProvider = "RegressionTestScripts")
	public void runTC_SF_OBEMEAManagerContactsRecordUpdation(String testInstance, ExecutionMode executionMode, Platform platform
