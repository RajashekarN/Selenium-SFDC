...
public class TC_SF_ASAPACBrokerAccountsVerifyingPickListValues extends CRAFTTestCase {
	@Test(dataProvider = "RegressionTestScripts")
	public void runTC_SF_ASAPACBrokerAccountsVerifyingPickListValues(String testInstance, ExecutionMode executionMode, Platform platform
