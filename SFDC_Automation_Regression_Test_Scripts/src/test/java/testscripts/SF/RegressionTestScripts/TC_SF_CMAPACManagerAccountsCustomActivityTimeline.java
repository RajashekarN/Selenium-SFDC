...
public class TC_SF_CMAPACManagerAccountsCustomActivityTimeline extends CRAFTTestCase
{
	@Test(dataProvider = "RegressionTestScripts")
	public void runTC_SF_CMAPACManagerAccountsCustomActivityTimeline(String testInstance, ExecutionMode executionMode, Platform platform
