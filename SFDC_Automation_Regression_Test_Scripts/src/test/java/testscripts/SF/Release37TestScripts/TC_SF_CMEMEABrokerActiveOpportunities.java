...
public class TC_SF_CMEMEABrokerActiveOpportunities extends CRAFTTestCase {
	@Test(dataProvider = "RegressionTestScripts")
	public void runTC_SF_CMEMEABrokerActiveOpportunities(String testInstance, ExecutionMode executionMode, Platform platform
