...
public class TC_SF_CMAMERManagerContactsPopulatingRequiredFieldsPage extends CRAFTTestCase
{
	@Test(groups= {"REGRESSION","API","Manager","Contact","Field"},dataProvider = "RegressionTestScripts")
	public void runTC_SF_CMAMERManagerContactsPopulatingRequiredFieldsPage(String testInstance, ExecutionMode executionMode, Platform platform
