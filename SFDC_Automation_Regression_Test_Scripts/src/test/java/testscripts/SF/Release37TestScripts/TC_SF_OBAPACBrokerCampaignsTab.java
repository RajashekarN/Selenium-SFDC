 ...
 *
 */
public class TC_SF_OBAPACBrokerCampaignsTab extends CRAFTTestCase
{
	@Test(dataProvider = "RegressionTestScripts")
	public void runTC_SF_OBAPACBrokerCampaignsTab(String testInstance, ExecutionMode executionMode, Platform platform
