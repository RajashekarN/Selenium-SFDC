 ...
 *
 */
public class TC_SF_GWSEMEABrokerOpportunityNameAutoGenerate extends CRAFTTestCase
{
	@Test(dataProvider = "RegressionTestScripts")
	public void runTC_SF_GWSEMEABrokerOpportunityNameAutoGenerate(String testInstance, ExecutionMode executionMode, Platform platform
