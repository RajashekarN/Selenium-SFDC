...
/**
 * Test Script to do the ConvertLead by adding the existing account in the Convert Lead page
 * 
 * @author Vishnuvardhan
 *
 */

public class TC_SF_OBAMERBrokerConvertLeadExistingAccount extends CRAFTTestCase
{
	@Test(groups= {"SMOKE","API","Broker","Lead","Convert"},dataProvider = "SmokeTestScripts")
	public void runTC_SF_OBAMERBrokerConvertLeadExistingAccount(String testInstance, ExecutionMode executionMode, Platform platform
			/*MobileToolName mobileToolName,
			MobileExecutionPlatform executionPlatform, String deviceName*/)
	{
		SeleniumTestParameters testParameters = new SeleniumTestParameters(currentScenario, currentTestcase);
		testParameters.setCurrentTestDescription("Test to do the ConvertLead by adding the existing account in the Convert Lead page");
